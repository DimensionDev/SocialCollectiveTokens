...
// Compared to SocialController.sol, it has a rearranged order of variables in the Creator struct (not allowed).
// Additionally, the state variables latestId and idByUsername have swapped places.

contract SocialController_v1_1_NonUpgradeable is
    Initializable,
    PriceCalculator,
    ERC1155Upgradeable,
    UUPSUpgradeable,
    OwnableUpgradeable
{
    struct Creator {
        ...
        // sequence of numOfOutstandingTokens and creatorAddress are swapped around
    ...
    // CAUTION: DO NOT CHANGE ORDER & TYPE OF THESE VARIABLES
    // FOR ADDITION OF NEW STATE VARIABLES, ADD IT BELOW THE LATEST ONE
    // GOOGLE KEYWORDS "SOLIDITY, UPGRADEABLE CONTRACTS, STORAGE" FOR MORE INFO
    mapping(bytes32 => uint256) public idByUsername; // switched from L.48 to L.47
    uint256 public latestId; // switched from L.47 to L.48
